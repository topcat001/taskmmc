// Generated using:
// mgmtclassgen Win32_process /n root\cimv2 /l CS /p Process.cs
...
Example: 20480.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The PrivatePageCount property specifies the current number of bytes allocated tha" +
        ...
        public uint GetOwner(out string Domain, out string User) {
            if ((isEmbedded == false)) {
                ...
                User = null;
                System.Management.ManagementBaseObject inParams = null;
                bool EnablePrivileges = PrivateLateBoundObject.Scope.Options.EnablePrivileges; // Save original privileges.
                PrivateLateBoundObject.Scope.Options.EnablePrivileges = true;
                try
                {
                    // This can fail if the process exits early.
                ...
                catch (Exception e)
                {
                    ...
                    {
                        Domain = e.InnerException.Message;
                    }
                    else
                    {
                        Domain = "";
                ...
                {
                    PrivateLateBoundObject.Scope.Options.EnablePrivileges = EnablePrivileges; // Restore privileges.
                }
        ...
        [Flags] // Not really flags, but marked as such for ToString.
